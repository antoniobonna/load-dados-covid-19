...
file = 'coronavirus_pernambuco.xlsx'
current_local = 'Pernambuco'
...
def parseRow(row):
    ...
    icu_inpatients = int(beds_icu * row['icu_rate'])
    inpatients = int(beds_nursery * row['nursery_rate']) + icu_inpatients
